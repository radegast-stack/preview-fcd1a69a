(function(){
  ...
  setTimeout(function(){if(!ioFired){document.querySelectorAll('.reveal').forEach(function(e){e.classList.add('in');});}},3000);
  ...
  if(lt){
    var one=logos.map(function(l){return '<div class="logo-m"><img src="'+l[0]+'" alt="'+l[1]+'" loading="lazy"></div>';}).join('');
